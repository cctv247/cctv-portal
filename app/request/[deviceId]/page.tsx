...
export default function RequestPage() {
  ...
  if (loading) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8fafc]">
      ...
      <p className="text-[10px] font-black uppercase tracking-[4px] text-slate-400 italic">Verifying Geolocation...</p>
    </div>
  );
        ...
        <div className="p-6 sm:p-8 space-y-4">
          {inRange ? (
            <div className="space-y-6">
              ...
              {/* Request Form (Shows when Forgot Password is clicked) */}
              {isFormOpen && (
                <div className="space-y-4 animate-in slide-in-from-top-4 duration-500 bg-blue-50/30 p-6 rounded-[35px] border-2 border-blue-50">
                  ...
                  <button 
                    ...
                    className="w-full bg-blue-600 text-white py-4 rounded-[22px] font-black uppercase text-[10px] tracking-[3px] shadow-xl disabled:opacity-50 active:scale-95 transition-all flex items-center justify-center gap-2"
                  >
            ...
            <div className="py-12 text-center space-y-5">
               ...
               <p className="text-slate-400 text-[10px] font-bold uppercase tracking-[4px] px-4"> Please be present at the site to sync GPS. </p>
